...
MX1508 mouthMotor(11, 10); // Sets up an MX1508 controlled motor on PWM pins 11 and 10
MX1508 tailMotor(5, 3); // Sets up an MX1508 controlled motor on PWM pins 5 and 3
...
void openMouth() {
  ...
  mouthMotor.backward(); //open the mouth
  delay(300);
  mouthMotor.halt();
  delay(500);
}
...
void closeMouth() {
  ...
  mouthMotor.forward(); // close the mouth
  delay(300);
  mouthMotor.halt();
  delay(500);
}
...
void flap() {
  tailMotor.setSpeed(255); //set the body motor to full speed
  tailMotor.backward(); //move the body motor to raise the tail
  delay(200); //wait a bit, for dramatic effect
  tailMotor.forward();
  delay(200);
